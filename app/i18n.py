...
_translations: dict[str, dict[str, str]] = {
    ...
    "split.cut0": {"en": "No split", "ja": "分割なし", "zh": "不切"},
    "split.cut1": {"en": "Split every 4 sentences", "ja": "4文ごとに分割", "zh": "凑四句一切"},
    "split.cut2": {"en": "Split every 50 chars", "ja": "50字ごとに分割", "zh": "凑50字一切"},
    "split.cut3": {"en": "Split by Chinese period", "ja": "中国語句点で分割", "zh": "按中文句号切"},
    "split.cut4": {"en": "Split by English period", "ja": "英語ピリオドで分割", "zh": "按英文句号切"},
    "split.cut5": {"en": "Split by all punctuation", "ja": "全句読点で分割", "zh": "按标点符号切"},
